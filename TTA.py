...
DEFAULT_ACTIONAGENT_SYSTEM_PROMPT = (
    ...
    "<think>\n"
    "I will fetch data from example.com using requests and BeautifulSoup, "
    "store it in a pandas DataFrame, and write it to a CSV file. "
    "Network and file operations will be wrapped in try/except. I need to be very carefull and make sure the code is properly indented\n"
    "</think>\n\n"
    "<code>\n"
    "{\n"
    ...
    "    print('ACTIONENGINE: OK - headlines.csv created')\\n"
    "except Exception as e:\\n"
...
# ---------------------------
# Small test runner (when run directly)
# ---------------------------
